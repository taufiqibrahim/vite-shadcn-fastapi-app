...
<body style="font-family: Arial, sans-serif; background-color: #f9f9f9; padding: 30px;">
  <div style="max-width: 600px; margin: auto; background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 5px rgba(0,0,0,0.1); padding: 20px;">
    ...
    <p>
      <a href="{settings.APP_URL}" style="display: inline-block; background-color: #4CAF50; color: white; padding: 12px 20px; text-decoration: none; border-radius: 5px; font-size: 16px;">Go to App</a>
    </p>
...
async def send_password_reset_email(recipient: str, password_reset_token: str):
    url = f"{settings.APP_URL}/account/confirm-password-reset?{password_reset_token}"
    subject = f"Reset Password Requested!"
    body = f"""<!DOCTYPE html>
<html>
<head>
  <meta charset="UTF-8">
...
<body style="font-family: Arial, sans-serif; background-color: #f9f9f9; padding: 30px;">
  <div style="max-width: 600px; margin: auto; background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 5px rgba(0,0,0,0.1); padding: 20px;">
    ...
    <p>
      <a href="{url}" style="display: inline-block; background-color: #4CAF50; color: white; padding: 12px 20px; text-decoration: none; border-radius: 5px; font-size: 16px;">Reset password</a>
    </p>
    <p style="font-size: 14px; color: #3c3f3c;">
      If you have any questions, feel free to reach out to our support team.
    </p>
