...
Revision ID: 001
Revises:
Create Date: 2025-04-26 22:05:59.760020
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "account_type",
            sa.Enum("USER", "SERVICE_ACCOUNT", name="accounttype"),
            nullable=True,
        ),
    ...
    op.create_index(
        op.f("ix_account_profile_id"), "account_profile", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_account_profile_uid"), "account_profile", ["uid"], unique=True
    )
    op.create_table(
        "api_key",
        sa.Column("id", sa.Integer(), nullable=False),
